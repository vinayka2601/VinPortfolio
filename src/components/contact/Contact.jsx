...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
          .sendForm('service_dvbuz1l', 'template_5olt38e', formRef.current, {
            publicKey: '8p8c7wSQjNVzmG9W4',
          })
          .then(
            (result) => {
             setSuccess(true)
    ...
    className="contact"variants={variants} initial="initial" whileInView="animate">
        <motion.div className="textContainer"variants={variants}>
           ...
           <motion.div className="item"variants={variants}>
            <h2>Mail</h2>
            <span>vinaykaawasthi26@gmail.com</span>
           </motion.div>
